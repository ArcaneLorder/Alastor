...
void newobj::lua::module::json::push_obj(newobj::lua::module::json* value)
{
...
void newobj::lua::module::json::set_obj(const std::string& name, newobj::lua::module::json* value)
{
	m_json[name] = value->m_json;
}
void newobj::lua::module::regist_json(void* config, kaguya::State* L)
{
	...
	table.addFunction("push_obj", &newobj::lua::module::json::push_obj);
	...
	table.addFunction("set_obj", &newobj::lua::module::json::set_obj);
