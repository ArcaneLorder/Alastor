; Listing generated by Microsoft (R) Optimizing Compiler Version 19.36.32537.0 
	...
	TITLE	D:\Code\Alastor\Thirdparty\zlib\contrib\vstudio\vc14\x86\TestZlibDebug\Tmp\inflate.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG44079 DB	'1.2.13', 00H
	ORG $+1
$SG44639 DB	'incorrect header check', 00H
	ORG $+1
$SG44641 DB	'unknown compression method', 00H
	ORG $+1
$SG44645 DB	'invalid window size', 00H
$SG44649 DB	'unknown compression method', 00H
	ORG $+1
$SG44651 DB	'unknown header flags set', 00H
	ORG $+3
$SG44698 DB	'header crc mismatch', 00H
$SG44715 DB	'invalid block type', 00H
	ORG $+1
$SG44719 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG44731 DB	'too many length or distance symbols', 00H
$SG44735 DB	'invalid code lengths set', 00H
	ORG $+3
$SG44745 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG44751 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG44754 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG44756 DB	'invalid literal/lengths set', 00H
$SG44758 DB	'invalid distances set', 00H
	ORG $+2
$SG44772 DB	'invalid literal/length code', 00H
$SG44783 DB	'invalid distance code', 00H
	ORG $+2
$SG44793 DB	'invalid distance too far back', 00H
	ORG $+2
$SG44806 DB	'incorrect data check', 00H
	ORG $+3
$SG44811 DB	'incorrect length check', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Code\Alastor\Thirdparty\zlib\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 207  :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG44079[edx]
	cmp	eax, ecx
...
; 683  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG44639
...
; 688  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG44641
...
; 697  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44645
...
; 713  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG44649
...
; 718  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44651
...
; 834  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44698
...
; 896  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44715
...
; 905  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44719
...
; 946  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44731
...
; 969  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG44735
...
; 993  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44745
...
; 1016 :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44751
...
; 1030 :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44754
...
; 1044 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44756
...
; 1053 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44758
...
; 1107 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG44772
...
; 1145 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG44783
...
; 1177 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG44793
...
; 1236 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44806
...
; 1250 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG44811
