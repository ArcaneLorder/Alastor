; Listing generated by Microsoft (R) Optimizing Compiler Version 19.36.32537.0 
	...
	TITLE	D:\Code\Alastor\Thirdparty\zlib\contrib\vstudio\vc14\x86\TestZlibDebug\Tmp\infback.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG44020 DB	'1.2.13', 00H
	ORG $+1
$SG44406 DB	'invalid block type', 00H
	ORG $+1
$SG44411 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG44423 DB	'too many length or distance symbols', 00H
$SG44427 DB	'invalid code lengths set', 00H
	ORG $+3
$SG44438 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG44446 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG44449 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG44451 DB	'invalid literal/lengths set', 00H
$SG44453 DB	'invalid distances set', 00H
	ORG $+2
$SG44469 DB	'invalid literal/length code', 00H
$SG44481 DB	'invalid distance code', 00H
	ORG $+2
$SG44486 DB	'invalid distance too far back', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Code\Alastor\Thirdparty\zlib\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 37   :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG44020[edx]
	cmp	eax, ecx
...
; 321  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44406
...
; 332  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44411
...
; 370  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44423
...
; 392  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44427
...
; 415  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44438
...
; 438  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44446
...
; 452  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44449
...
; 466  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44451
...
; 475  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44453
...
; 534  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44469
...
; 566  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44481
...
; 581  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44486
