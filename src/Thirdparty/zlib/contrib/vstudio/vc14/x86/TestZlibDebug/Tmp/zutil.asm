; Listing generated by Microsoft (R) Optimizing Compiler Version 19.36.32537.0 
	...
	TITLE	D:\Code\Alastor\Thirdparty\zlib\contrib\vstudio\vc14\x86\TestZlibDebug\Tmp\zutil.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
_DATA	SEGMENT
$SG47535 DB	'need dictionary', 00H
$SG47536 DB	'stream end', 00H
	ORG $+1
$SG47538 DB	'file error', 00H
	ORG $+1
$SG47539 DB	'stream error', 00H
	ORG $+3
$SG47540 DB	'data error', 00H
	ORG $+1
$SG47541 DB	'insufficient memory', 00H
$SG47542 DB	'buffer error', 00H
	ORG $+3
$SG47543 DB	'incompatible version', 00H
_DATA	ENDS
CONST	SEGMENT
_z_errmsg DD	FLAT:$SG47535
	DD	FLAT:$SG47536
	DD	FLAT:$SG47537
	DD	FLAT:$SG47538
	DD	FLAT:$SG47539
...
_DATA	SEGMENT
	ORG $+3
$SG47546 DB	'1.2.13', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Code\Alastor\Thirdparty\zlib\zutil.c
_TEXT	SEGMENT
_opaque$ = 8						; size = 4
_ptr$ = 12						; size = 4
_zcfree	PROC
