; Listing generated by Microsoft (R) Optimizing Compiler Version 19.36.32537.0 
	...
	TITLE	D:\Code\Alastor\Thirdparty\zlib\contrib\vstudio\vc14\x86\TestZlibDebug\Tmp\inftrees.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
_inflate_copyright DB ' inflate 1.2.13 Copyright 1995-2022 Mark Adler ', 00H
...
; File D:\Code\Alastor\Thirdparty\zlib\inftrees.c
_TEXT	SEGMENT
_offs$ = -148						; size = 32
_count$ = -116						; size = 32
_mask$ = -84						; size = 4
