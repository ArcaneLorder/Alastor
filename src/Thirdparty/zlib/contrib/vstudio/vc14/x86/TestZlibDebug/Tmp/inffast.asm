; Listing generated by Microsoft (R) Optimizing Compiler Version 19.36.32537.0 
	...
	TITLE	D:\Code\Alastor\Thirdparty\zlib\contrib\vstudio\vc14\x86\TestZlibDebug\Tmp\inffast.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG44084 DB	'invalid distance too far back', 00H
	ORG $+2
$SG44099 DB	'invalid distance code', 00H
	ORG $+2
$SG44104 DB	'invalid literal/length code', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Code\Alastor\Thirdparty\zlib\inffast.c
_TEXT	SEGMENT
_whave$ = -92						; size = 4
_beg$ = -88						; size = 4
_dmask$ = -84						; size = 4
...
; 174  :                             strm->msg =
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44084
...
; 271  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG44099
...
; 286  :             strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44104
