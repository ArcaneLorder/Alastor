; Listing generated by Microsoft (R) Optimizing Compiler Version 19.36.32537.0 
	...
	TITLE	D:\Code\Alastor\Thirdparty\zlib\contrib\vstudio\vc14\x86\TestZlibDebug\Tmp\testzlib.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG101181 DB	'rb', 00H
	ORG $+5
$SG101242 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG101245 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG101246 DB	'file %s read, %u bytes', 0aH, 00H
$SG101250 DB	'1.2.13', 00H
	ORG $+1
$SG101251 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG101252 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG101253 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG101254 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG101255 DB	'1.2.13', 00H
	ORG $+1
$SG101256 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG101257 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG101258 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG101259 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG101262 DB	'compare ok', 0aH, 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File D:\Code\Alastor\Thirdparty\zlib\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
